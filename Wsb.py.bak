...
sys.stdout.write ("\x1b]2; Virus | Welcome Guns | Expiry:9999-99-99 \x07")
def modifications():
...
def title():                                                                                      
    ...
    stdout.write("                              "+Fore.RED+"▀  ▀▀▀.▀   "+Fore.LIGHTBLACK_EX+"▀ ▀▀▀  ▀▀▀▀                 \n")                    
    stdout.write("             \n")      
    stdout.write("              "+Fore.LIGHTWHITE_EX+"                  • "+Fore.RED   +"Welcome To Virus "+Fore.LIGHTWHITE_EX+"•              \n")
    stdout.write("              "+Fore.LIGHTWHITE_EX+"           • "+Fore.RED   +"To Get Started Type [Commands] "+Fore.LIGHTWHITE_EX+"•           \n") 
    stdout.write("              "+Fore.LIGHTWHITE_EX+"          •  "+Fore.RED  +"https://discord.gg/exposeservices "+Fore.LIGHTWHITE_EX+"•            \n")  
    stdout.write("                                                                                     \n")
    stdout.write("                       "+Fore.WHITE   +"╔════════════════════════════════════╗\n")
    stdout.write("                       "+Fore.WHITE   +"║                                    ║\n")          
    stdout.write("                       "+Fore.WHITE   +"║      "+Fore.RED+            "You want a custom Botnet   "+Fore.LIGHTWHITE_EX+"   ║\n")
    stdout.write("                       "+Fore.WHITE +"║"+Fore.WHITE+"         Discord | gunzss       "+Fore.LIGHTWHITE_EX+"    ║\n")
    stdout.write("                       "+Fore.RED   +"║                                    ║\n")  
    stdout.write("                       "+Fore.RED   +"║                                    ║\n") 
    stdout.write("                       "+Fore.RED   +"╚════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTWHITE_EX+"User @Guns" +Fore.LIGHTBLACK_EX+" ▪ " +Fore.RED+"Virus " +Fore.RED+"$$ "+Fore.WHITE)
    command = input()
