...
def animate():
    for c in itertools.cycle(['|', '/', '-', '\\']):
        if done:
            break
        sys.stdout.write('\rLoading [$WebSlammerBD] ' + c)
        sys.stdout.flush()
        time.sleep(0.1)

sys.stdout.write ("\x1b]2; Web Slammer | Welcome WSB | Expiry:9999-99-99 \x07")
def modifications():
	print ("Contact Gunszz for other nets/scripts > DO NOT CONTACT FOR HELP WITH SCRIPTS ONLY PAY IF YOU KNOW HOW TO DO IT YOURSELF")
...
print("""
Welcome To Web Slammer Bangladesh """)
...
def help():
    clear()
    stdout.write(""+Fore.WHITE+"Sub: "+Fore.GREEN+"99/99/9999 "+Fore.WHITE+"| "+Fore.WHITE+"User: @Guns | "+Fore.YELLOW+"Telegram: "+Fore.RED+"Gunszzs "+Fore.WHITE+"|"+Fore.LIGHTMAGENTA_EX+" Instagram: "+Fore.WHITE+"@Gunszzs \n")                                                                                                                                                 
    stdout.write("                                                                                                              \n")                    
...
def credits():
    stdout.write("                                        \n")
    stdout.write("             "+Fore.RED         +"╔═════════════════════════════════════════════════════╗\n")
    stdout.write("             "+Fore.RED         +"║ • "+Fore.LIGHTWHITE_EX+" Discord  "+Fore.RED+"           ||"+Fore.LIGHTWHITE_EX+" gunszz"+Fore.RED+"           ║\n")
    stdout.write("             "+Fore.RED         +"║ • "+Fore.LIGHTWHITE_EX+" Methods/Development   "+Fore.RED+"||"+Fore.LIGHTWHITE_EX+" Guns   "+Fore.RED+"      ║\n") 
    stdout.write("             "+Fore.RED         +"║ • "+Fore.LIGHTWHITE_EX+" Tiktok  "+Fore.RED+"       ||"+Fore.LIGHTWHITE_EX+" @gunszzs "+Fore.RED+"          ║\n")                                                   
    stdout.write("             "+Fore.RED         +"╚═════════════════════════════════════════════════════╝\n")  
    stdout.write("\n")   
##############################################################################################
def layer7():
    ...
    stdout.write(""+Fore.WHITE+"Sub: "+Fore.GREEN+"99/99/9999 "+Fore.WHITE+"| "+Fore.WHITE+"User: @Guns | "+Fore.YELLOW+"Telegram: "+Fore.RED+"Gunszzs "+Fore.WHITE+"|"+Fore.LIGHTMAGENTA_EX+" Instagram: "+Fore.WHITE+"@Gunszzs \n")                                                
    stdout.write("                                                                                                                        \n")                           
    stdout.write("        "+Fore.LIGHTWHITE_EX+"          •  "+Fore.LIGHTWHITE_EX+"UDP & TCP Are For Home ISP Only "+Fore.LIGHTWHITE_EX+"• \n")
    stdout.write("       "+Fore.LIGHTWHITE_EX+"          •  "+Fore.LIGHTWHITE_EX+"All Other Methods Are For Websites "+Fore.LIGHTWHITE_EX+"• \n")          
    stdout.write("     "+Fore.RED+"                                                                                 \n")
    stdout.write("     "+Fore.RED+"    ███▄ ▄███▓▓█████▄▄▄█████▓ ██░ ██  ▒█████  ▓█████▄   ██████          \n")    
    stdout.write("     "+Fore.RED+"   ▓██▒▀█▀ ██▒▓█   ▀▓  ██▒ ▓▒▓██░ ██▒▒██▒  ██▒▒██▀ ██▌▒██    ▒          \n")
    stdout.write("     "+Fore.RED+"   ▓██    ▓██░▒███  ▒ ▓██░ ▒░▒██▀▀██░▒██░  ██▒░██   █▌░ ▓██▄            \n")
    ...
    stdout.write("     "+Fore.RED+"   ░  ░      ░ ░ ░  ░   ░     ▒ ░▒░ ░  ░ ▒ ▒░  ░ ▒  ▒ ░ ░▒  ░ ░         \n")   
    stdout.write("               "+Fore.RED+" ╔════════════════╗     ╔═════════════════╗\n")
    stdout.write("               "+Fore.RED+" ║ "+Fore.WHITE+" tcp   udp     "+Fore.RED+"║     ║ "+Fore.WHITE+"  post  req     "+Fore.RED+"║\n")
    stdout.write("               "+Fore.RED+" ║ "+Fore.WHITE+" cfb   http2   "+Fore.RED+"║     ║ "+Fore.WHITE+"  soc  raw      "+Fore.RED+"║\n")
    stdout.write("               "+Fore.RED+" ║ "+Fore.WHITE+"sky  get  pps  "+Fore.RED+"║     ║ "+Fore.WHITE+" head  spoof    "+Fore.RED+"║\n")         
    stdout.write("               "+Fore.RED+" ╚════════════════╝     ╚═════════════════╝\n") 
    stdout.write("\n")
##############################################################################################
def layer4():
...
##############################################################################################
def title():                                                                                      
    stdout.write(""+Fore.WHITE+"Sub: "+Fore.GREEN+"99/99/9999 "+Fore.WHITE+"| "+Fore.WHITE+"User: @wsb | "+Fore.YELLOW+"Telegram: "+Fore.RED+" xohanchowdhury "+Fore.WHITE+"|"+Fore.LIGHTMAGENTA_EX+" Instagram: "+Fore.WHITE+"@ridhwan.mahamud \n")
    stdout.write("                              \n")
    stdout.write("                       \n")                           
    stdout.write("                             "+Fore.RED+"Web"+Fore.LIGHTBLACK_EX+"                   \n")
    stdout.write("                            "+Fore.RED  +"Slammer "+Fore.LIGHTBLACK_EX+"                 \n")
    stdout.write("                            "+Fore.RED   +"Bangladesh  "+Fore.LIGHTBLACK_EX+"               \n")
    stdout.write("                            "+Fore.RED+" "+Fore.LIGHTBLACK_EX+"               \n")                         
    stdout.write("                              "+Fore.RED+"   "+Fore.LIGHTBLACK_EX+"     \n")                    
    stdout.write("             \n")      
    stdout.write("              "+Fore.LIGHTWHITE_EX+"              • "+Fore.RED+"Welcome To Web Slammer Bangladesh  "+Fore.LIGHTWHITE_EX+"•              \n")
    stdout.write("              "+Fore.LIGHTWHITE_EX+"           • "+Fore.RED   +"To Get Started Type [Commands] "+Fore.LIGHTWHITE_EX+"•           \n") 
    stdout.write("              "+Fore.LIGHTWHITE_EX+"          • "+Fore.RED+ 
 "https://www.facebook.com/gazipurcybersercurecommunity.official "+Fore.LIGHTWHITE_EX+"•            \n")  
    stdout.write("                                                                                     \n")
    stdout.write("                       "+Fore.WHITE   +"╔════════════════════════════════════╗\n")
    stdout.write("                       "+Fore.WHITE   +"║                                    ║\n")          
    stdout.write("                       "+Fore.WHITE   +"║      "+Fore.RED+            "Contact Me for Any Help    "+Fore.LIGHTWHITE_EX+"   ║\n")
    stdout.write("                       "+Fore.WHITE +"║"+Fore.WHITE+"      Facebook | Xohan Chowdhury"+Fore.LIGHTWHITE_EX+"    ║\n")
    stdout.write("                       "+Fore.RED   +"║                                    ║\n")  
    stdout.write("                       "+Fore.RED   +"║                                    ║\n") 
    stdout.write("                       "+Fore.RED   +"╚════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTWHITE_EX+"User @WebSlammerBD" +Fore.LIGHTBLACK_EX+" ▪ " +Fore.RED+"WSB " +Fore.RED+"$$ "+Fore.WHITE)
    command = input()
